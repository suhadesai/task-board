...
export default function EditNoteModal({ isOpen, onClose, onSubmit, task }) {
  ...
  const noteColor = NOTE_COLORS[task.colorIndex % NOTE_COLORS.length];
        ...
        >
          ...
          >
            <div style={{
              ...
              background: 'radial-gradient(circle at 35% 35%, #3498dbdd, #2176ae)',
            ...
            <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end', marginTop: 18 }}>
              ...
              <Btn onClick={handleSubmit} style={submitStyle}>Save!</Btn>
            </div>
          </motion.div>
        </motion.div>
      )}
...
const submitStyle = { background: '#2176ae', color: 'white' };